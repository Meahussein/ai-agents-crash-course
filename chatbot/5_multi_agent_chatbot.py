...
#Calorie lookup function as a tool
@function_tool
...
#Healthy breakfast advisor agent
...
#Making calorie agent into a tool
...
#Making breakfast planner agent into a tool 
...
#Final agent that glues everything together
...
#chainlit session memory
@cl.on_chat_start
async def on_chat_start():
    session = SQLiteSession("conversation_history")
    cl.user_session.set("agent_session", session)

#chainlit setup and connection to agent
@cl.on_message
